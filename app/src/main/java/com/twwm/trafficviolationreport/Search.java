...
public class Search extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        arrayAdapter = new ListAdapter(Search.this, R.layout.list_item, threadMap, threadNames, threadTime, threadLink);
...
//                            threadLocation.add("Latitude: \n" + document.getString("Latitude") + " " + "\nLongitude: \n" + document.getString("Longitude"));
                ...
                {
                    Toast.makeText(Search.this, "Failed to load list.", Toast.LENGTH_LONG).show();
                }
        ...
        mThreadListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int i, long id) {
                ...
                Intent intent = new Intent(Search.this, ViewInfo.class);
